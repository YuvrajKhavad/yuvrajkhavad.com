			...
			<div class="header-wrapper clearfix">
				<div class="header-inside clearfix">
					...
					<?php if ( get_theme_mod( 'author_customizer_logo' ) ) { ?>
						<div class="logo-img">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img class="logo rotate" src="<?php echo esc_url( get_theme_mod( 'author_customizer_logo' ) );?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" /></a>
						</div>
						<div class="logo-text">
